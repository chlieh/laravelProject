        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'index')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">Accueil</span><span
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">Les factures</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    ...
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-chartjs')) }}">Factures non payées</a>
                    </li>
                    <li><a class="slide-item" href="{{ url('/' . ($page = 'chart-echart')) }}">Factures payée Amount</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">Rapports</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">Configuration</span><i
